...
#define AI_DIGIT_CNN_MODEL_SIGNATURE     "0xf5550a5a9328524d28f5e7a470dd2875"
...
#define AI_TOOLS_DATE_TIME   "2025-06-21T21:12:33+0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 1, 5, 5, 8), AI_STRIDE_INIT(4, 4, 4, 32, 160),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    11304, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 3636, 1, 1),
    3636, NULL, NULL),
  ...
  &conv2d_conv2d_layer, 0xcc84ccdc, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_digit_cnn_activations_map, 1, params)) {
    ...
    conv2d_conv2d_scratch0_array.data = AI_PTR(g_digit_cnn_activations_map[0] + 3536);
    conv2d_conv2d_scratch0_array.data_start = AI_PTR(g_digit_cnn_activations_map[0] + 3536);
    ...
    conv2d_output_array.data = AI_PTR(g_digit_cnn_activations_map[0] + 0);
    conv2d_output_array.data_start = AI_PTR(g_digit_cnn_activations_map[0] + 0);
    conv2d_1_conv2d_scratch0_array.data = AI_PTR(g_digit_cnn_activations_map[0] + 2048);
    conv2d_1_conv2d_scratch0_array.data_start = AI_PTR(g_digit_cnn_activations_map[0] + 2048);
    conv2d_1_conv2d_output_array.data = AI_PTR(g_digit_cnn_activations_map[0] + 2336);
    conv2d_1_conv2d_output_array.data_start = AI_PTR(g_digit_cnn_activations_map[0] + 2336);
    conv2d_1_output_array.data = AI_PTR(g_digit_cnn_activations_map[0] + 0);
    conv2d_1_output_array.data_start = AI_PTR(g_digit_cnn_activations_map[0] + 0);
    dense_dense_output_array.data = AI_PTR(g_digit_cnn_activations_map[0] + 576);
    dense_dense_output_array.data_start = AI_PTR(g_digit_cnn_activations_map[0] + 576);
