...
#define AI_DIGIT_CNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_DIGIT_CNN_OUT_1_CHANNEL     (3)
#define AI_DIGIT_CNN_OUT_1_SIZE        (3)
#define AI_DIGIT_CNN_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_DIGIT_CNN_N_NODES (6)
